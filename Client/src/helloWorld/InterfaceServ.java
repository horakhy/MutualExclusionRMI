...
public interface InterfaceServ extends Remote {
	...
	public String registrarLiberacao(String text, InterfaceCli referenciaCliente, int numRecurso) throws RemoteException, RemoteException, NoSuchAlgorithmException;
}
